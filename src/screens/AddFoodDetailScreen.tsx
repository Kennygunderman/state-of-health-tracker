...
import foodSearchService, { BrandedFoodItem } from '../service/food/FoodSearchService';
import { addFood } from '../store/food/FoodActions';
import FoodItem, { createFood, generateId } from '../store/food/models/FoodItem';
...
const AddFoodDetailScreen = ({ navigation, route }: any) => {
    const {
        path,
        mealId,
        mealName,
...
export default AddFoodDetailScreen;
